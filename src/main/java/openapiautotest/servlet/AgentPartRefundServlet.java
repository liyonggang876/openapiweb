...
public class AgentPartRefundServlet extends HttpServlet {

    /**
     * Constructor of the object.
     */
    public AgentPartRefundServlet() {
        super();
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if((type != null) && (type.trim() != "")){
            ...
            OutInfo.msg("代理部分商退款店铺编号=" + agentNum);
            ...
            if((requestNum.trim() != "") &&  (requestNum != null) && (customerNum.trim() != "") &&  (customerNum != null) && (shopNum.trim() != "")
                ...
                String res = "error";
                res = ti.agentPartRefund(key, customerNum, shopNum, requestNum, agentNum);
